import { TopCryptoCurrencies } from "../constants/TopCryptocurrencies";
import { CryptoCurrencySelectorProps } from "../types/types";
import { AnimatePresence, motion } from "framer-motion";
import React, { MutableRefObject, useEffect, useState } from "react";

export const CryptoCurrencySelector = React.forwardRef<
  HTMLDivElement,
      ...
      <div className="mt-1 relative">
        ...
        >
          <span className="block truncate flex items-center">
            <img
              alt={props.selectedValue.symbol}
              src={props.selectedValue.logo}
        ...
        <AnimatePresence>
          {props.open && (
            ...
            >
              ...
              >
                {TopCryptoCurrencies.filter((cryptocurrency) =>
                  cryptocurrency.name
                    .toLowerCase()
                  ...
                  TopCryptoCurrencies.filter((cryptocurrency) =>
                    ...
                    return (
                      ...
                      >
                        {/* <img
                          alt={`${value.title}`}
                          //https://github.com/spothq/cryptocurrency-icons/blob/master/32/icon/aave.png
                          src={`https://github.com/spothq/cryptocurrency-icons/blob/master/32/icon/${value.value}.png`}
                          className={"inline mr-2 h-4 rounded-sm"}
                        /> */}

                        {/* <img
                          alt={props.selectedValue.name}
                          src={
                            props.selectedValue.symbol
                              ? `https://raw.githubusercontent.com/spothq/cryptocurrency-icons/master/32/icon/${props.selectedValue.symbol.toLowerCase()}.png`
                              : dummyCoinURL
                          }
                          className={"inline mr-2 h-4 rounded-sm"}
                        /> */}

                        {/* {props.selectedValue.logo ? (
                          <img
                            alt={props.selectedValue.symbol}
                            src={props.selectedValue.logo}
                            className={"inline mr-2 h-4 rounded-sm"}
                        ...
                        {value.symbol === props.selectedValue.symbol ? (
